...
path_to_data_profiles_js = "./src/data/data_profiles.js"
path_to_data_problems_js = "./src/data/data_problems.js"
...
out = "export const Problems = " + data.to_json(orient='records')
